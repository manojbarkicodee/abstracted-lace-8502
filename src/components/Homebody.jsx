...
const Homebody = () => {
  ...
  return (
   <Box position="relative" top="100px"   >
    <Flex bg="#ebf7fc" flexDirection="horizontal"  w="100%" border="1px solid black" h="650px" >
        <Box w="55%"  letterSpacing="0.01px" wordSpacing="0.01px"  border="1px solid black" p="80px 0px 0px 80px"  >
        ...
        <video width="100%" height="200px" className='vedio'   ref={vedio} autoplay muted preload='auto' playsinline  loop  >
  ...
  Your browser does not support the video tag.
    ...
    <Box textAlign="center" pt="60px" lineHeight="35px" h="400px" border="1px solid black">
    ...
    <Flex bg="#faf2f4" flexDirection="horizontal"  w="100%"  h="650px" >
        ...
        <Box w="55%"  border="1px solid black" pt="80px">
  ...
  Your browser does not support the video tag.
    ...
    <Box>
      <Flex bg="#faf2f4" flexDirection="horizontal"  w="100%"  h="300px" border="1px solid black">
    ...
    <Flex flexDirection="horizontal"  w="100%"  h="300px" border="1px solid black">
...
<Text color="#1f64ca" fontSize="lg">Watch video<ArrowForwardIcon color="#1f64ca" /></Text>
    ...
    <Box  textAlign="center">
      <Heading as="h2" w="400px">300,000+ innovative companies use Airtable every day. Join them.</Heading>
      <Button mt="30px" w="280px" fontSize="25px" p="5px" bg="blue" textColor="white">sign up for free</Button>
